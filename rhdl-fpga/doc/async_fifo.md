...
<title>{data: r@(Some(ee10)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(ee10)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(ee10)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(47dd)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(47dd)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(47dd)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(3805)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(3805)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(3805)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9c49)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9c49)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9c49)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(7706)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(7706)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(7706)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(4c29)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(4c29)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(bc61)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(bc61)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(bc61)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9212)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9212)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9212)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b5dd)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b5dd)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b5dd)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b0c6)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b0c6)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b0c6)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(b0c6)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9444)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9444)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(9444)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(c5f4)), next: b@(0), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(c5f4)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(a936)), next: b@(1), cr_w: r@({clock: 0, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(a936)), next: b@(1), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 1, reset: 0})}</title>
</text>
...
<title>{data: r@(Some(a936)), next: b@(0), cr_w: r@({clock: 1, reset: 0}), cr_r: b@({clock: 0, reset: 0})}</title>
</text>
...
r@...
<title>r@(Some(b0c6))</title>
</text>
<path d="M 1100 50 L 1103 43 L 1197 43 L 1200 50 L 1197 57 L 1103 57 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
r@...
<title>r@(Some(9444))</title>
</text>
<path d="M 1250 50 L 1253 43 L 1497 43 L 1500 50 L 1497 57 L 1253 57 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
r@...
<title>r@(Some(c5f4))</title>
</text>
<path d="M 1550 50 L 1553 43 L 1647 43 L 1650 50 L 1647 57 L 1553 57 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
So...
<title>Some(b0c6)</title>
</text>
<path d="M 1100 70 L 1103 63 L 1197 63 L 1200 70 L 1197 77 L 1103 77 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
So...
<title>Some(9444)</title>
</text>
<path d="M 1250 70 L 1253 63 L 1497 63 L 1500 70 L 1497 77 L 1253 77 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
So...
<title>Some(c5f4)</title>
</text>
<path d="M 1550 70 L 1553 63 L 1647 63 L 1650 70 L 1647 77 L 1553 77 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
<path d="M 900 90 L 903 83 L 947 83 L 950 90 L 947 97 L 903 97 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
<path d="M 1100 90 L 1103 83 L 1197 83 L 1200 90 L 1197 97 L 1103 97 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
<path d="M 1250 90 L 1253 83 L 1497 83 L 1500 90 L 1497 97 L 1253 97 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
<path d="M 1550 90 L 1553 83 L 1647 83 L 1650 90 L 1647 97 L 1553 97 Z" fill="none" stroke="#D62246" stroke-width="1"/>
...
<path d="M 850 110 L 853 103 L 897 103 L 900 110 L 897 117 L 853 117 Z" fill="none" stroke="#D62246" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="875" xml:space="preserve" y="110">
bc61
<title>bc61</title>
</text>
...
<rect fill="#1E3155" height="14" stroke="none" width="76" x="513" y="123"/>
<path d="M 512 130 L 512 123 L 590 123 L 590 130" fill="none" stroke="#5C95FF" stroke-width="1"/>
<path d="M 590 130 L 590 137 L 824 137 L 824 130" fill="none" stroke="#5C95FF" stroke-width="1"/>
<rect fill="#1E3155" height="14" stroke="none" width="232" x="825" y="123"/>
<path d="M 824 130 L 824 123 L 1058 123 L 1058 130" fill="none" stroke="#5C95FF" stroke-width="1"/>
<path d="M 1058 130 L 1058 137 L 1370 137 L 1370 130" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<rect fill="#1E3155" height="14" stroke="none" width="154" x="1527" y="123"/>
<path d="M 1526 130 L 1526 123 L 1682 123 L 1682 130" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<rect fill="#1E3155" height="14" stroke="none" width="76" x="513" y="143"/>
<path d="M 512 150 L 512 143 L 590 143 L 590 150" fill="none" stroke="#5C95FF" stroke-width="1"/>
<path d="M 590 150 L 590 157 L 824 157 L 824 150" fill="none" stroke="#5C95FF" stroke-width="1"/>
<rect fill="#1E3155" height="14" stroke="none" width="232" x="825" y="143"/>
<path d="M 824 150 L 824 143 L 1058 143 L 1058 150" fill="none" stroke="#5C95FF" stroke-width="1"/>
<path d="M 1058 150 L 1058 157 L 1370 157 L 1370 150" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<rect fill="#1E3155" height="14" stroke="none" width="154" x="1527" y="143"/>
<path d="M 1526 150 L 1526 143 L 1682 143 L 1682 150" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
{dat...
<title>{data: b@(Some(ee10)), almost_empty: b@(1), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
...
{dat...
<title>{data: b@(Some(47dd)), almost_empty: b@(1), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
<path d="M 629 330 L 632 323 L 860 323 L 863 330 L 860 337 L 632 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
...
{data: b@(Some(47dd)...
<title>{data: b@(Some(47dd)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
...
<title>{data: b@(Some(3805)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
<path d="M 875 330 L 878 323 L 922 323 L 925 330 L 922 337 L 878 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
...
{d...
<title>{data: b@(Some(3805)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
<path d="M 925 330 L 928 323 L 938 323 L 941 330 L 938 337 L 928 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="933" xml:space="preserve" y="330">

<title>{data: b@(Some(3805)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
<path d="M 941 330 L 944 323 L 972 323 L 975 330 L 972 337 L 944 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="958" xml:space="preserve" y="330">

<title>{data: b@(Some(9c49)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(0), overflow: r@(0)}</title>
</text>
...
{...
<title>{data: b@(Some(9c49)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
<path d="M 1019 330 L 1022 323 L 1222 323 L 1225 330 L 1222 337 L 1022 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1122" xml:space="preserve" y="330">
{data: b@(Some(77...
<title>{data: b@(Some(7706)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
...
<title>{data: b@(Some(7706)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(1)}</title>
</text>
<path d="M 1250 330 L 1253 323 L 1406 323 L 1409 330 L 1406 337 L 1253 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1329" xml:space="preserve" y="330">
{data: b@(So...
<title>{data: b@(Some(7706)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(0)}</title>
</text>
...
{da...
<title>{data: b@(Some(4c29)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(0)}</title>
</text>
...
{d...
<title>{data: b@(Some(4c29)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
...
<title>{data: b@(Some(4c29)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(1)}</title>
</text>
<path d="M 1550 330 L 1553 323 L 1562 323 L 1565 330 L 1562 337 L 1553 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1557" xml:space="preserve" y="330">

<title>{data: b@(Some(4c29)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(0)}</title>
</text>
<path d="M 1565 330 L 1568 323 L 1622 323 L 1625 330 L 1622 337 L 1568 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1595" xml:space="preserve" y="330">
{da...
<title>{data: b@(Some(bc61)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(0)}</title>
</text>
<path d="M 1625 330 L 1628 323 L 1640 323 L 1643 330 L 1640 337 L 1628 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1634" xml:space="preserve" y="330">

<title>{data: b@(Some(bc61)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
<path d="M 1643 330 L 1646 323 L 1672 323 L 1675 330 L 1672 337 L 1646 337 Z" fill="none" stroke="#E7ECEF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1659" xml:space="preserve" y="330">

<title>{data: b@(Some(9212)), almost_empty: b@(0), underflow: b@(0), full: r@(0), almost_full: r@(1), overflow: r@(0)}</title>
</text>
...
<title>{data: b@(Some(9212)), almost_empty: b@(0), underflow: b@(0), full: r@(1), almost_full: r@(1), overflow: r@(1)}</title>
</text>
...
b@(S...
<title>b@(Some(ee10))</title>
</text>
<path d="M 551 350 L 554 343 L 860 343 L 863 350 L 860 357 L 554 357 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
b@(S...
<title>b@(Some(9c49))</title>
</text>
<path d="M 1019 350 L 1022 343 L 1406 343 L 1409 350 L 1406 357 L 1022 357 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
b@(Some(4c29))
<title>b@(Some(4c29))</title>
</text>
<path d="M 1565 350 L 1568 343 L 1640 343 L 1643 350 L 1640 357 L 1568 357 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1604" xml:space="preserve" y="350">
b@(S...
<title>b@(Some(bc61))</title>
</text>
<path d="M 1643 350 L 1646 343 L 1679 343 L 1682 350 L 1679 357 L 1646 357 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1662" xml:space="preserve" y="350">

<title>b@(Some(9212))</title>
</text>
...
<path d="M 551 370 L 554 363 L 860 363 L 863 370 L 860 377 L 554 377 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<path d="M 1019 370 L 1022 363 L 1406 363 L 1409 370 L 1406 377 L 1022 377 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<path d="M 1565 370 L 1568 363 L 1640 363 L 1643 370 L 1640 377 L 1568 377 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1604" xml:space="preserve" y="370">
Some...
<title>Some(bc61)</title>
</text>
<path d="M 1643 370 L 1646 363 L 1679 363 L 1682 370 L 1679 377 L 1646 377 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="1662" xml:space="preserve" y="370">
...
<path d="M 551 410 L 554 403 L 860 403 L 863 410 L 860 417 L 554 417 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<path d="M 1019 410 L 1022 403 L 1406 403 L 1409 410 L 1406 417 L 1022 417 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
...
<path d="M 1565 410 L 1568 403 L 1640 403 L 1643 410 L 1640 417 L 1568 417 Z" fill="none" stroke="#5C95FF" stroke-width="1"/>
<text dominant-baseline="middle" fill="#D4D4D4" font-family="monospace" font-size="10px" text-anchor="middle" x="