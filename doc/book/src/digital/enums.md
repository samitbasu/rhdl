...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:prelude}}
```

 Let's `impl Digital` for the following (still relatively simple) `enum`:

```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:def}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:BITS}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:derive}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:static_kind}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:bin}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:dont_care}}
```
...
```rust
{{#rustdoc_include ../code/src/digital/enum_ex.rs:test_opcode_layout}}
```

![OpCode Layout](../code/opcode.svg)
