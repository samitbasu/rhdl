...
```rust
{{#rustdoc_include ../code/src/kernels/arrays.rs:step_1}}
```
...
```rust
{{#rustdoc_include ../code/src/kernels/arrays.rs:step_2}}
```
...
```rust
{{#rustdoc_include ../code/src/kernels/arrays.rs:step_3}}
```
...
```rust
{{#rustdoc_include ../code/src/kernels/arrays.rs:step_4}}
```
