...
```rust
{{#rustdoc_include ../code/src/bits/mod.rs:alias-b13}}
```
...
```rust
{{#rustdoc_include ../code/src/bits/mod.rs:alias-s12}}
```
...
```rust
{{#rustdoc_include ../code/src/bits/mod.rs:explicit_versions}}
```
...
```rust
{{#rustdoc_include ../code/src/bits/mod.rs:where-for-fn}}
```
