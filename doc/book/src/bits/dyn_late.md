...
```rust
{{#rustdoc_include bits_ex/src/main.rs:late_checking_1}}
```
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:late_checking_1_test}}
```

We get a straight panic:

<!-- cmdrun to-html "cd bits_ex && cargo test --features doc2 test_run_do_stuff 2>&1" -->
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:compile_do_stuff}}
```

<!-- cmdrun to-html "cd bits_ex && cargo test --features doc3 test_compile_do_stuff -- --nocapture 2>&1" -->
