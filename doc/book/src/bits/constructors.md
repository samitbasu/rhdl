...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_into}}
```
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_b8}}
```
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_bits}}
```
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_bits_turbofish}}
```
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_s8}}
```

but this does not:

```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_s8_non_synth}}
```

with error:

<!-- cmdrun to-html "cd bits_ex && cargo build --features doc1 2>&1" -->
...
```rust
{{#rustdoc_include bits_ex/src/main.rs:constructor_s8_synth}}
```
