...
```rust
{{#rustdoc_include ../code/src/synchronous.rs:synchronous_trait_descriptor}}
```
...
```rust
{{#rustdoc_include ../code/src/synchronous.rs:hdl-descriptor}}
```
...
```rust
{{#rustdoc_include ../code/src/synchronous.rs:verilog}}
```
