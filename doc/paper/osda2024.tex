...
the full expressiveness of the underlying language to hardware design.  These improvements
promise to make the development of hardware designs more accessible, easier to test and 
...
\bibitem{b10} ``Diesel is a Safe, Extensible ORM and Query Builder for Rust'', \url{https://diesel.rs/} (Accessed Feb 4, 2024).
