    ...
    let _ = {
        let module0 = {
            ...
            let item0 = rhdl::vlog::Item::Statement(
                rhdl::vlog::Stmt::ContinuousAssign(rhdl::vlog::Assign {
                    target: stringify!(b).into(),
                    rhs: Box::new(
                        rhdl::vlog::Expr::Binary(rhdl::vlog::ExprBinary {
                            lhs: Box::new(rhdl::vlog::Expr::Ident(stringify!(a).into())),
                            op: rhdl::vlog::BinaryOp::Plus,
