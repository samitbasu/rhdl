    ...
    let _ = {
        let module0 = {
            ...
            let item0 = rhdl::vlog::Item::Statement(
                rhdl::vlog::Stmt::FunctionCall({
                    let arg0 = rhdl::vlog::Expr::Ident(stringify!(a).into());
                    let arg1 = rhdl::vlog::Expr::Ident(stringify!(b).into());
                    rhdl::vlog::FunctionCall {
                        name: stringify!(_my_function).into(),
                        args: vec![arg0, arg1,],
                    }
                }),
            );
