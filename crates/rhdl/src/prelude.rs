...
pub use rhdl_core::trace2::session::Session;
pub use rhdl_core::trace2::svg::SvgFile as Svg;
pub use rhdl_core::trace2::svg::options::SvgOptions;
pub use rhdl_core::trace2::vcd::VcdFile as Vcd;
