...
use crate::get_bit::get_bit;

pub fn signed<const N: usize>(x: Bits<N>) -> SignedBits<N> {
...
impl<const N: usize> DigitalFn for signed<N> {
...
mod tests {
    ...
    #[test]
    fn test_signed() {
        assert_eq!(signed(Bits::<8>(0b1111_1111)), SignedBits::<8>(-1));
        assert_eq!(signed(Bits::<8>(0b0000_0000)), SignedBits::<8>(0));
        assert_eq!(signed(Bits::<8>(0b0000_0001)), SignedBits::<8>(1));
    }
}
