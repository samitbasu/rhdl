...
impl TestThing {
    ...
    fn is_dyn(self) -> bool {
        match self {
            TestThing::DynBits(_, _) => true,
            TestThing::SignedDynBits(_, _) => true,
            _ => false,
        }
    }
    fn is_lit(self) -> bool {
        match self {
            TestThing::UnsignedLiteral(_) => true,
            TestThing::SignedLiteral(_) => true,
            _ => false,
        }
    }
}
...
fn shift_op_size(x: Option<u8>, y: Option<u8>) -> Option<u8> {
    x
}
