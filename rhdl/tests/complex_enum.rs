...
fn test_size_case() {
    ...
    assert_eq!(
        foo_test
            ...
            .unwrap()
            .bits,
        b16::from(0b1010101010101010).bitx()
    );
    assert_eq!(
        foo_test
            .path(&Path::default().payload("Size").field("w"))
    ...
    assert_eq!(
        foo_test
            ...
            .unwrap()
            .bits,
        b16::from(0b1101010110101010).bitx()
    );
    assert_eq!(
        foo_test.path(&Path::default().discriminant()).unwrap().bits,
        b5::from(0b00010).bitx()
    );
}
