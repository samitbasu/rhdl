...
fn test_nested_enum_match_in_if_let_fails() -> miette::Result<()> {
    ...
    let expect_err = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(337d6b63af79c5a7): SpannedSource { source: "fn add(state: Signal<Option<Foo>, Red>) -> Signal<b8, Red> {\n    if let Some(Foo::Red(Bar(x, y))) = state.val() {\n        signal(x + y)\n    } else {\n        signal(bits(0))\n    }\n}\n", name: "add", span_map: {N19: 147..178, N24: 0..180, N16: 164..171, N3: 100..111, N0: 7..12, N22: 65..178, N6: 86..95, N13: 122..135, N8: 72..97, N23: 59..180, N12: 122..135, N4: 90..91, N15: 169..170, N14: 112..141, N17: 157..172, N1: 7..38, N9: 129..130, N2: 100..105, N20: 147..178, N7: 77..96, N18: 157..172, N21: 65..178, N11: 129..134, N5: 93..94, N10: 133..134}, fallback: N24, filename: "rhdl/tests/binding.rs:29", function_id: FnID(337d6b63af79c5a7) }}, ranges: {FnID(337d6b63af79c5a7): 0..181} }, err_span: SourceSpan { offset: SourceOffset(86), length: 9 } }))"#]];
