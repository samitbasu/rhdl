...
fn test_nested_enum_match_in_if_let_fails() -> miette::Result<()> {
    ...
    let expect_err = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(e34db5bc6a623ce2): SpannedSource { source: "fn add(state: Signal<Option<Foo>, Red>) -> Signal<b8, Red> {\n    if let Some(Foo::Red(Bar(x, y))) = state.val() {\n        signal((x + y).resize())\n    } else {\n        signal(bits(0))\n    }\n}\n", name: "add", span_map: {N18: 175..182, N26: 0..191, N16: 112..152, N14: 122..146, N10: 134..135, N6: 86..95, N5: 93..94, N12: 129..136, N2: 100..105, N11: 130..135, N0: 7..12, N3: 100..111, N8: 72..97, N23: 65..189, N9: 130..131, N25: 59..191, N15: 122..146, N4: 90..91, N13: 129..145, N19: 168..183, N24: 65..189, N7: 77..96, N17: 180..181, N21: 158..189, N20: 168..183, N22: 158..189, N1: 7..38}, fallback: N26, filename: "rhdl/tests/binding.rs:29", function_id: FnID(e34db5bc6a623ce2) }}, ranges: {FnID(e34db5bc6a623ce2): 0..192} }, err_span: SourceSpan { offset: SourceOffset(86), length: 9 } }))"#]];
