...
fn test_nested_enum_match_in_if_let_fails() -> miette::Result<()> {
    ...
    let expect_err = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(2e72e8e06978f49d): SpannedSource { source: "fn add(state: Signal<Option<Foo>, Red>) -> Signal<b8, Red> {\n    if let Some(Foo::Red(Bar(x, y))) = state.val() {\n        signal((x + y).resize())\n    } else {\n        signal(bits(0))\n    }\n}\n", name: "add", span_map: {N6: 86..95, N20: 168..183, N17: 180..181, N7: 77..96, N15: 122..146, N10: 134..135, N8: 72..97, N21: 158..189, N22: 158..189, N5: 93..94, N18: 175..182, N2: 100..105, N9: 130..131, N24: 65..189, N16: 112..152, N14: 122..146, N3: 100..111, N0: 7..12, N12: 129..136, N4: 90..91, N25: 59..191, N26: 0..191, N1: 7..38, N11: 130..135, N23: 65..189, N13: 129..145, N19: 168..183}, fallback: N26, filename: "rhdl/tests/binding.rs:29", function_id: FnID(2e72e8e06978f49d) }}, ranges: {FnID(2e72e8e06978f49d): 0..192} }, err_span: SourceSpan { offset: SourceOffset(86), length: 9 } }))"#]];
