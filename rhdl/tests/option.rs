...
fn test_option_result_nested_option_result_destructure() -> miette::Result<()> {
    ...
    let expect = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(28b0f91d4b051211): SpannedSource { source: "fn do_stuff(i: Signal<Option<Result>, Red>) -> Signal<Option<ResponseCode>, Red> {\n    let resp = i.val();\n    let d = match resp {\n        Some(Result::Ok(())) => Some(ResponseCode::OKAY),\n        Some(Result::Err(e)) => {\n            Some(\n                match e {\n                    AXI4Error::SLVERR => ResponseCode::SLVERR,\n                    AXI4Error::DECERR => ResponseCode::DECERR,\n                },\n            )\n        }\n        None => None,\n    };\n    signal(d)\n}\n", name: "do_stuff", span_map: {N19: 309..329, N10: 145..159, N2: 91..95, N15: 215..216, N6: 87..106, N23: 258..411, N0: 12..13, N11: 140..160, N21: 372..392, N34: 470..479, N22: 351..393, N3: 98..99, N28: 445..458, N1: 12..42, N35: 81..481, N16: 203..217, N20: 288..330, N4: 98..105, N24: 236..426, N27: 453..457, N31: 111..465, N17: 198..218, N18: 264..265, N13: 164..188, N5: 87..106, N8: 125..129, N36: 0..481, N29: 119..464, N33: 470..479, N25: 198..436, N32: 477..478, N9: 156..158, N26: 445..449, N30: 111..465, N12: 169..187, N7: 115..116, N14: 140..189}, fallback: N36, filename: "rhdl/tests/option.rs:319", function_id: FnID(28b0f91d4b051211) }}, ranges: {FnID(28b0f91d4b051211): 0..482} }, err_span: SourceSpan { offset: SourceOffset(156), length: 2 } }))"#]];
    let res = compile_design::<do_stuff>(CompilationMode::Asynchronous);
    expect.assert_eq(&format!("{:?}", res));
    Ok(())
}
...
fn test_option_result_nested_option_result_destructure_simple() -> miette::Result<()> {
    ...
    let expect_err = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(f7b4ab65ff1d920a): SpannedSource { source: "fn do_stuff(i: Signal<Option<Result>, Red>) -> Signal<Option<AXI4Error>, Red> {\n    let resp = i.val();\n    let d = match resp {\n        Some(Result::Ok(())) => Some(AXI4Error::SLVERR),\n        Some(Err(e)) => Some(e),\n        None => None,\n    };\n    signal(d)\n}\n", name: "do_stuff", span_map: {N11: 137..157, N8: 122..126, N22: 235..239, N1: 12..42, N9: 153..155, N27: 259..260, N14: 137..185, N12: 166..183, N2: 88..92, N13: 161..184, N6: 84..103, N3: 95..96, N30: 78..263, N23: 227..240, N26: 108..247, N4: 95..102, N5: 84..103, N10: 142..156, N21: 227..231, N28: 252..261, N20: 194..218, N19: 210..217, N16: 199..205, N17: 194..206, N31: 0..263, N29: 252..261, N25: 108..247, N18: 215..216, N15: 203..204, N24: 116..246, N0: 12..13, N7: 112..113}, fallback: N31, filename: "rhdl/tests/option.rs:357", function_id: FnID(f7b4ab65ff1d920a) }}, ranges: {FnID(f7b4ab65ff1d920a): 0..264} }, err_span: SourceSpan { offset: SourceOffset(153), length: 2 } }))"#]];
