...
fn test_option_result_match_func() -> miette::Result<()> {
    ...
    let expect = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(c951a9c843e4dd5b): SpannedSource { source: "fn do_stuff(i: Signal<Option<Result>, Red>) -> Signal<Option<ResponseCode>, Red> {\n    let d = match i.val() {\n        Some(Result::Ok(())) => Some(ResponseCode::OKAY),\n        Some(Result::Err(e)) => Some(err_map(e)),\n        None => None,\n    };\n    signal(d)\n}\n", name: "do_stuff", span_map: {N16: 201..217, N28: 0..263, N3: 101..102, N4: 101..108, N10: 119..168, N6: 124..138, N5: 135..137, N11: 194..195, N20: 227..240, N7: 119..139, N19: 235..239, N14: 214..215, N18: 227..231, N0: 12..13, N1: 12..42, N21: 95..246, N25: 252..261, N2: 91..92, N17: 177..218, N24: 259..260, N27: 81..263, N12: 182..196, N15: 206..216, N8: 148..166, N9: 143..167, N26: 252..261, N22: 87..247, N13: 177..197, N23: 87..247}, fallback: N28, filename: "rhdl/tests/option.rs:186", function_id: FnID(c951a9c843e4dd5b) }}, ranges: {FnID(c951a9c843e4dd5b): 0..264} }, err_span: SourceSpan { offset: SourceOffset(135), length: 2 } }))"#]];
...
fn test_option_result_nested_option_result_destructure() -> miette::Result<()> {
    ...
    let expect = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(b4f885acad2da549): SpannedSource { source: "fn do_stuff(i: Signal<Option<Result>, Red>) -> Signal<Option<ResponseCode>, Red> {\n    let resp = i.val();\n    let d = match resp {\n        Some(Result::Ok(())) => Some(ResponseCode::OKAY),\n        Some(Result::Err(e)) => {\n            Some(\n                match e {\n                    AXI4Error::SLVERR => ResponseCode::SLVERR,\n                    AXI4Error::DECERR => ResponseCode::DECERR,\n                },\n            )\n        }\n        None => None,\n    };\n    signal(d)\n}\n", name: "do_stuff", span_map: {N19: 309..329, N34: 470..479, N7: 115..116, N21: 372..392, N30: 111..465, N9: 156..158, N25: 198..436, N26: 445..449, N35: 81..481, N20: 288..330, N28: 445..458, N32: 477..478, N2: 91..95, N14: 140..189, N13: 164..188, N33: 470..479, N24: 236..426, N17: 198..218, N31: 111..465, N36: 0..481, N3: 98..99, N8: 125..129, N22: 351..393, N11: 140..160, N23: 258..411, N12: 169..187, N4: 98..105, N15: 215..216, N27: 453..457, N16: 203..217, N1: 12..42, N29: 119..464, N0: 12..13, N6: 87..106, N5: 87..106, N10: 145..159, N18: 264..265}, fallback: N36, filename: "rhdl/tests/option.rs:318", function_id: FnID(b4f885acad2da549) }}, ranges: {FnID(b4f885acad2da549): 0..482} }, err_span: SourceSpan { offset: SourceOffset(156), length: 2 } }))"#]];
    let res = compile_design::<do_stuff>(CompilationMode::Asynchronous);
    expect.assert_eq(&format!("{:?}", res));
    Ok(())
}
...
fn test_option_result_nested_option_result_destructure_simple() -> miette::Result<()> {
    ...
    let expect_err = expect![[r#"Err(RHDLTypeError(RHDLTypeError { cause: PathMismatchInTypeInference, src: SourcePool { source: {FnID(1024e163f0320f30): SpannedSource { source: "fn do_stuff(i: Signal<Option<Result>, Red>) -> Signal<Option<AXI4Error>, Red> {\n    let resp = i.val();\n    let d = match resp {\n        Some(Result::Ok(())) => Some(AXI4Error::SLVERR),\n        Some(Err(e)) => Some(e),\n        None => None,\n    };\n    signal(d)\n}\n", name: "do_stuff", span_map: {N5: 84..103, N3: 95..96, N18: 215..216, N20: 194..218, N21: 227..231, N16: 199..205, N8: 122..126, N2: 88..92, N31: 0..263, N9: 153..155, N12: 166..183, N7: 112..113, N25: 108..247, N30: 78..263, N4: 95..102, N26: 108..247, N22: 235..239, N15: 203..204, N14: 137..185, N0: 12..13, N6: 84..103, N10: 142..156, N17: 194..206, N1: 12..42, N11: 137..157, N27: 259..260, N28: 252..261, N24: 116..246, N19: 210..217, N29: 252..261, N13: 161..184, N23: 227..240}, fallback: N31, filename: "rhdl/tests/option.rs:354", function_id: FnID(1024e163f0320f30) }}, ranges: {FnID(1024e163f0320f30): 0..264} }, err_span: SourceSpan { offset: SourceOffset(153), length: 2 } }))"#]];
